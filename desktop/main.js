...
<html
    ...
    if (!wallpapers || wallpapers.length === 0) {
        ...
        let res;
        try {
            res = await fetch(window.location.pathname + "desktop/img/wallpapers/list.json");
        } catch {
    ...
    if (!dockScript || DEBUG) {
        let res;
        try {
            res = await fetch(window.location.pathname + "desktop/js/dock.js");
        } catch {
    ...
    if ((!dockCss && dockScript) || DEBUG) {
        let res;
        try {
            res = await fetch(window.location.pathname + "desktop/css/dock.css");
        } catch {
    ...
    if (!searchScript || DEBUG) {
        let res;
        try {
            res = await fetch(window.location.pathname + "desktop/js/search.js");
        } catch {
    ...
    if ((!searchCss && searchScript) || DEBUG) {
        let res;
        try {
            res = await fetch(window.location.pathname + "desktop/css/search.css");
        } catch {
    ...
    if (!appCss || DEBUG) {
        let res;
        try {
            res = await fetch(window.location.pathname + "desktop/css/defaultapp.css");
        } catch {
    ...
    if (!appList || DEBUG) {
        let res;
        try {
            res = await fetch(window.location.pathname + "desktop/app/list.json");
        } catch {
